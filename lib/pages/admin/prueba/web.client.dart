...
class _ListaPdfsPersonalState extends State<ListaPdfsPersonal> with WidgetsBindingObserver {
  ...
  Widget pdfs(String nombrePdf, String url){
        ...
        secondaryActions: <Widget>[
          ...
          IconSlideAction(
            ...
            onTap: (){
              ...
              _requestDownload("http://www.elsoca.org/pdf/libreria/programa_de_transicion.pdf");
            },
          ),
        ],
        child: Container(
  ...
  void _requestDownload(String url) async {
    await FlutterDownloader.enqueue(
        url: "http://www.elsoca.org/pdf/libreria/programa_de_transicion.pdf",
        headers: {
